// This uses the syntax in the medium article, but is incomplete.
...
var RakuDocHighlightRules = function () {
...
RakuDocHighlightRules.metaData = {
    fileTypes: [ 'rakudoc' ],
    keyEquivalent: '^~R',
    name: 'RakuDoc',
    scopeName: 'source.rakudoc'
};

oop.inherits(RakuDocHighlightRules, TextHighlightRules);

exports.RakuDocHighlightRules = RakuDocHighlightRules;